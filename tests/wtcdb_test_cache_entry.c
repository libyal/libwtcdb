...
/* Windows Vista cache entry with invalid signature
 */
uint8_t wtcdb_test_cache_entry_error_data1[ 88 ] = {
	0xff, 0xff, 0xff, 0xff, 0x58, 0x00, 0x00, 0x00, 0x16, 0xd7, 0xf9, 0x93, 0xb2, 0x27, 0x26, 0xd5,
	0x6c, 0x00, 0x6e, 0x00, 0x6b, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x74, 0xf9, 0xe6, 0x9c, 0x7c, 0x32, 0x07, 0xf0, 0x35, 0x00, 0x33, 0x00, 0x36, 0x00, 0x31, 0x00,
	0x38, 0x00, 0x64, 0x00, 0x61, 0x00, 0x38, 0x00, 0x32, 0x00, 0x62, 0x00, 0x65, 0x00, 0x64, 0x00,
...
/* Windows Vista cache entry with invalid cache entry size
 */
uint8_t wtcdb_test_cache_entry_error_data2[ 88 ] = {
	0x43, 0x4d, 0x4d, 0x4d, 0x00, 0x00, 0x00, 0x00, 0x16, 0xd7, 0xf9, 0x93, 0xb2, 0x27, 0x26, 0xd5,
	0x6c, 0x00, 0x6e, 0x00, 0x6b, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x74, 0xf9, 0xe6, 0x9c, 0x7c, 0x32, 0x07, 0xf0, 0x35, 0x00, 0x33, 0x00, 0x36, 0x00, 0x31, 0x00,
	0x38, 0x00, 0x64, 0x00, 0x61, 0x00, 0x38, 0x00, 0x32, 0x00, 0x62, 0x00, 0x65, 0x00, 0x64, 0x00,
...
/* Windows Vista cache entry with invalid identifier size
 */
uint8_t wtcdb_test_cache_entry_error_data3[ 88 ] = {
	0x43, 0x4d, 0x4d, 0x4d, 0x58, 0x00, 0x00, 0x00, 0x16, 0xd7, 0xf9, 0x93, 0xb2, 0x27, 0x26, 0xd5,
	0x6c, 0x00, 0x6e, 0x00, 0x6b, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x74, 0xf9, 0xe6, 0x9c, 0x7c, 0x32, 0x07, 0xf0, 0x35, 0x00, 0x33, 0x00, 0x36, 0x00, 0x31, 0x00,
	0x38, 0x00, 0x64, 0x00, 0x61, 0x00, 0x38, 0x00, 0x32, 0x00, 0x62, 0x00, 0x65, 0x00, 0x64, 0x00,
	0x37, 0x00, 0x38, 0x00, 0x66, 0x00, 0x62, 0x00 };

/* Windows Vista cache entry with invalid padding size
 */
uint8_t wtcdb_test_cache_entry_error_data4[ 88 ] = {
	0x43, 0x4d, 0x4d, 0x4d, 0x58, 0x00, 0x00, 0x00, 0x16, 0xd7, 0xf9, 0x93, 0xb2, 0x27, 0x26, 0xd5,
	0x6c, 0x00, 0x6e, 0x00, 0x6b, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x74, 0xf9, 0xe6, 0x9c, 0x7c, 0x32, 0x07, 0xf0, 0x35, 0x00, 0x33, 0x00, 0x36, 0x00, 0x31, 0x00,
	0x38, 0x00, 0x64, 0x00, 0x61, 0x00, 0x38, 0x00, 0x32, 0x00, 0x62, 0x00, 0x65, 0x00, 0x64, 0x00,
	0x37, 0x00, 0x38, 0x00, 0x66, 0x00, 0x62, 0x00 };
     ...
     void )
{
	...
	result = libwtcdb_cache_entry_header_read_data(
	          cache_entry,
	          io_handle,
	          wtcdb_test_cache_entry_error_data1,
	          88,
	          &error );
	...
	result = libwtcdb_cache_entry_header_read_data(
	          cache_entry,
	          io_handle,
	          wtcdb_test_cache_entry_error_data2,
	          88,
	          &error );
     ...
     void )
{
	...
	/* Test invalid identifier size
	 */
	result = wtcdb_test_open_file_io_handle(
	          &file_io_handle,
	          wtcdb_test_cache_entry_error_data3,
	          88,
	          &error );
...
/* TODO implement */
	...
	result = wtcdb_test_open_file_io_handle(
	          &file_io_handle,
	          wtcdb_test_cache_entry_error_data4,
	          88,
	          &error );
