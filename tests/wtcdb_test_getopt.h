...
#if !defined( _WTCDB_TEST_GETOPT_H )
#define _WTCDB_TEST_GETOPT_H
...
#define wtcdb_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t wtcdb_test_getopt(
                  int argument_count,
...
#endif /* !defined( _WTCDB_TEST_GETOPT_H ) */
