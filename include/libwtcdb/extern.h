...
#if !defined( _LIBWTCDB_EXTERN_H )
#define _LIBWTCDB_EXTERN_H

/* To export functions from the libwtcdb DLL define LIBWTCDB_DLL_EXPORT
 * To import functions from the libwtcdb DLL define LIBWTCDB_DLL_IMPORT
