...
#if !defined( _WTCDBTOOLS_GETOPT_H )
#define _WTCDBTOOLS_GETOPT_H
...
typedef struct wtcdbtools_option wtcdbtools_option_t;

struct wtcdbtools_option
{
...
#define wtcdbtools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t wtcdbtools_getopt(
                  int argument_count,
...
void wtcdbtools_getopt_wrapped_fprint(
      FILE *stream,
...
void wtcdbtools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const wtcdbtools_option_t *options,
      int number_of_options );

int wtcdbtools_getopt_get_options_string(
     const wtcdbtools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _WTCDBTOOLS_GETOPT_H ) */
