...
void (*wtcdbtools_signal_signal_handler)( wtcdbtools_signal_t ) = NULL;
...
{
	static char *function = "wtcdbtools_signal_handler";
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( wtcdbtools_signal_signal_handler != NULL )
			{
				wtcdbtools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
...
{
	static char *function = "wtcdbtools_signal_attach";
	...
	wtcdbtools_signal_signal_handler = signal_handler;

	if( SetConsoleCtrlHandler(
	     (PHANDLER_ROUTINE) wtcdbtools_signal_handler,
	     TRUE ) == 0 )
	{
		libcerror_error_set(
		 error,
...
#if defined( _MSC_VER )
	wtcdbtools_signal_initialize_memory_debug();
#endif
...
int wtcdbtools_signal_detach(
     libcerror_error_t **error )
{
	static char *function = "wtcdbtools_signal_detach";
	...
	wtcdbtools_signal_signal_handler = NULL;
