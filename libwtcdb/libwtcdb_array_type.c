 ...
 */
int libwtcdb_array_initialize(
     libwtcdb_array_t **array,
     int number_of_entries,
     liberror_error_t **error )
{
	static char *function = "libwtcdb_array_initialize";
...
int libwtcdb_array_free(
     ...
     liberror_error_t **error )
{
	static char *function = "libwtcdb_array_free";
	int result            = 1;
...
int libwtcdb_array_empty(
     ...
     liberror_error_t **error )
{
	static char *function = "libwtcdb_array_empty";
...
int libwtcdb_array_clear(
     ...
     liberror_error_t **error )
{
	static char *function = "libwtcdb_array_clear";
...
int libwtcdb_array_clone(
     ...
     liberror_error_t **error )
{
	static char *function = "libwtcdb_array_clone";
	int entry_iterator    = 0;
     ...
     liberror_error_t **error )
{
	...
	static char *function = "libwtcdb_array_resize";
	size_t entries_size   = 0;
	int entry_iterator    = 0;
	int result            = 1;
 ...
 * Returns 1 if successful or -1 on error
 */
int libwtcdb_array_get_number_of_entries(
     libwtcdb_array_t *array,
     int *number_of_entries,
     liberror_error_t **error )
{
	static char *function = "libwtcdb_array_get_number_of_entries";
 ...
 * Returns 1 if successful or -1 on error
 */
int libwtcdb_array_get_entry_by_index(
     libwtcdb_array_t *array,
     int entry_index,
     intptr_t **entry,
     liberror_error_t **error )
{
	static char *function = "libwtcdb_array_get_entry_by_index";
 ...
 * Returns 1 if successful or -1 on error
 */
int libwtcdb_array_set_entry_by_index(
     libwtcdb_array_t *array,
     int entry_index,
     intptr_t *entry,
     liberror_error_t **error )
{
	static char *function = "libwtcdb_array_set_entry_by_index";
 ...
 * Returns 1 if successful or -1 on error
 */
int libwtcdb_array_append_entry(
     libwtcdb_array_t *array,
     int *entry_index,
     intptr_t *entry,
     liberror_error_t **error )
{
	static char *function = "libwtcdb_array_append_entry";
 ...
 * The entry_compare_function should return LIBWTCDB_ARRAY_COMPARE_LESS,
 * LIBWTCDB_ARRAY_COMPARE_EQUAL, LIBWTCDB_ARRAY_COMPARE_GREATER if successful or -1 on error
 *
 * Duplicate entries are allowed by default and inserted after the last duplicate entry.
 * Only allowing unique entries can be enforced by setting the flag LIBWTCDB_ARRAY_INSERT_FLAG_UNIQUE_ENTRIES
 *
 * Returns 1 if successful, 0 if the node already exists or -1 on error
 */
int libwtcdb_array_insert_entry(
     libwtcdb_array_t *array,
     int *entry_index,
     intptr_t *entry,
     ...
     liberror_error_t **error )
{
	static char *function = "libwtcdb_tree_node_insert_node";
	int entry_iterator    = 0;
	int result            = -1;
	...
	if( ( insert_flags & ~( LIBWTCDB_ARRAY_INSERT_FLAG_UNIQUE_ENTRIES ) ) != 0 )
	{
		liberror_error_set(
		 error,
		 LIBERROR_ERROR_DOMAIN_ARGUMENTS,
	...
	if( array->entries != NULL )
	{
		     ...
		     entry_iterator++ )
		{
			...
			else if( result == LIBWTCDB_ARRAY_COMPARE_EQUAL )
			{
				if( ( insert_flags & LIBWTCDB_ARRAY_INSERT_FLAG_UNIQUE_ENTRIES ) != 0 )
				{
					return( 0 );
			...
			else if( result == LIBWTCDB_ARRAY_COMPARE_LESS )
			{
				break;
			}
			else if( result != LIBWTCDB_ARRAY_COMPARE_GREATER )
			{
				liberror_error_set(
				 error,
				 LIBERROR_ERROR_DOMAIN_ARGUMENTS,
	...
	if( ( array->entries != NULL )
	 && ( result == LIBWTCDB_ARRAY_COMPARE_LESS ) )
	{
